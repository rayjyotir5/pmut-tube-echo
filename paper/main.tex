...
\caption{The central phenomenon. A 100\,kHz acoustic pulse launched by the PMUT at the
cylinder end cap travels the 3\,m oil column (launch, top), spreads and fills the bore
(mid-transit, middle), reflects off the steel piston face, and returns to the transducer about
4.2\,ms later (echo returns, bottom), where its time of flight gives the piston position. Red
and blue are positive and negative pressure; grey is steel. Frames are from the two-dimensional
FDTD simulation of Section~\ref{sec:fdtd}. At 200\,kHz and above the pulse is absorbed before it
can complete the round trip (Figure~\ref{fig:montage}); that frequency dependence is the main
...
the ranging question. Figure~\ref{fig:hero} shows the phenomenon at the heart of the study: the pulse making its round trip down the bore.
